...
<body >
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto mx-4">
                        ...
                        <a href="/carinalauricefernandez/loginpage.php" class="nav-item nav-link mx-4" style="font-family: Monaco, monospace; font-weight: bold;">LOGIN</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    height: 80vh; background-repeat: no-repeat; background-position: center; background-size: cover;">
        ...
        font-weight: bold;" href="/carinalauricefernandez/loginpage.php" role="button">SHOP</a>
    </div>
    <br><br>
    <div class="container-fluid">
